...
<head>
    ...
    <title>Radheya Enterprise</title>
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - View Contact Submissions -->
            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->first_name ?? Auth::user()->name }}</span>
                            ...
                            <form action="{{ route('portfolio.store') }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="filter" name="filter" required>
                                        <option value="filter-app"
                                            {{ old('filter') == 'filter-app' ? 'selected' : '' }}>App</option>
                                        <option value="filter-web"
                                            {{ old('filter') == 'filter-web' ? 'selected' : '' }}>Web</option>
                                        <option value="filter-card"
                                            {{ old('filter') == 'filter-card' ? 'selected' : '' }}>Card</option>
                                    </select>
                                </div>
                                <div class="mb-3">
